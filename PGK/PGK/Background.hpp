...
public:
	...
	void draw(mat4 MVP,mat4 Projection, mat4 View, mat4 Model, GLint TextureShaders , GLint MatrixID , GLint TextureID)
	{
		...
		MVP = Projection * View * Model* glm::translate(mat4(1.0f),vec3(0,0,-65))* glm::scale(glm::vec3(3.0f,1.5f,0.5f));
		DrawWithTexture(TextureShaders, MatrixID, MVP, logo_buffer, uvbuffer, logo, TextureID,6);

		MVP = Projection * View * Model* glm::translate(mat4(1.0f),vec3(0,0,-66))* glm::scale(glm::vec3(3.0f,1.5f,0.5f));
